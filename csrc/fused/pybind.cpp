...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
  ...
  m.def("transpose_pad_permute_scale_fuse_quant_cuda", py::overload_cast<torch::Tensor, torch::Tensor, torch::Tensor, int>(&transpose_pad_permute_scale_fuse_quant_cuda), "transpose_pad_permute_scale_fuse_quant_cuda");
}